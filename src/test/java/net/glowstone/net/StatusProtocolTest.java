...
{
	private static final Message[] TEST_MESSAGES = new Message[] {new StatusPingMessage( 1 ), new StatusResponseMessage( ProtocolTestUtils.getJson() ), new StatusRequestMessage(),};
