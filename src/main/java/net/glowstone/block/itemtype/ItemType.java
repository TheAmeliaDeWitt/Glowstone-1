...
public class ItemType
{
	...
	{
		if ( placeAs != null && placeAs.getContext().isBlockApplicable() )
	...
	public enum Context
	{
		...
		Context( boolean airApplicable, boolean blockApplicable )
		{
			this.airApplicable = airApplicable;
			this.blockApplicable = blockApplicable;
		}

		public boolean isAirApplicable()
		{
			return airApplicable;
		}

		public boolean isBlockApplicable()
		{
			return blockApplicable;
		}
	}
}
