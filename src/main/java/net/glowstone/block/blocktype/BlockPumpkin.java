...
{
	private static final BlockPattern IRONGOLEM_PATTERN = new BlockPattern( new BlockPattern.PatternItem( PUMPKIN, ( byte ) -1, 1, 0 ), new BlockPattern.PatternItem( IRON_BLOCK, ( byte ) 0, 0, 1 ), new BlockPattern.PatternItem( IRON_BLOCK, ( byte ) 0, 1, 1 ), new BlockPattern.PatternItem( IRON_BLOCK, ( byte ) 0, 2, 1 ), new BlockPattern.PatternItem( IRON_BLOCK, ( byte ) 0, 1, 2 ) );

	private static final BlockPattern SNOWMAN_PATTERN = new BlockPattern( new BlockPattern.PatternItem( PUMPKIN, ( byte ) -1, 0, 0 ), new BlockPattern.PatternItem( SNOW_BLOCK, ( byte ) 0, 0, 1 ), new BlockPattern.PatternItem( SNOW_BLOCK, ( byte ) 0, 0, 2 ) );
