...
{
	private static final BlockPattern WITHER_PATTERN = new BlockPattern( new BlockPattern.PatternItem( SKULL, ( byte ) 1, 0, 0 ), new BlockPattern.PatternItem( SKULL, ( byte ) 1, 1, 0 ), new BlockPattern.PatternItem( SKULL, ( byte ) 1, 2, 0 ), new BlockPattern.PatternItem( SOUL_SAND, ( byte ) 0, 0, 1 ), new BlockPattern.PatternItem( SOUL_SAND, ( byte ) 0, 1, 1 ), new BlockPattern.PatternItem( SOUL_SAND, ( byte ) 0, 2, 1 ), new BlockPattern.PatternItem( SOUL_SAND, ( byte ) 0, 1, 2 ) );
