...
public class BlockPotato extends BlockCrops
{
	...
	public Collection<ItemStack> getDrops( GlowBlock block, ItemStack tool )
	{
		if ( block.getData() >= CropState.RIPE.ordinal() )
		{
			...
			{
				return Collections.unmodifiableList( Arrays.asList( new ItemStack( Material.POTATO_ITEM, ThreadLocalRandom.current().nextInt( 4 ) + 1 ), new ItemStack( Material.POISONOUS_POTATO, 1 ) ) );
			}
			else
			{
