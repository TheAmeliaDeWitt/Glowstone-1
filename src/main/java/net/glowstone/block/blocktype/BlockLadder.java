...
public class BlockLadder extends BlockClimbable
{
	...
	{
		return super.canPlaceAt( block, against ) || isTargetOccluding( block, BlockFace.SOUTH ) || isTargetOccluding( block, BlockFace.WEST ) || isTargetOccluding( block, BlockFace.NORTH ) || isTargetOccluding( block, BlockFace.EAST );
	}
