...
public class Library
{
	...
	public static Library fromConfigMap( Map<?, ?> configMap )
	{
		...
		return new Library( group, artifact, version, repository, checksumType, checksumValue );
	}
	 ...
	 */
	public Library( String groupId, String artifactId, String version, HashAlgorithm checksumType, String checksumValue )
	{
	 ...
	 * @param checksumValue The checksum to validate the downloaded library against.
	 */
	public Library( String groupId, String artifactId, String version, String repository, HashAlgorithm checksumType, String checksumValue )
	{
	...
	public boolean equals( Object o )
	{
		...
		return Objects.equals( groupId, library.groupId ) && Objects.equals( artifactId, library.artifactId ) && Objects.equals( version, library.version );
	}
