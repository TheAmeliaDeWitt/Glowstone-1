...
{
	private static final SortedSet<Material> IGNORE_MATS = ImmutableSortedSet.of( Material.AIR, Material.WATER, Material.LAVA, Material.STATIONARY_LAVA, Material.STATIONARY_WATER );
	...
	public void handle( GlowSession session, UseItemMessage message )
	{
		...
		ItemStack holding = InventoryUtil.itemOrEmpty( player.getInventory().getItem( message.getEquipmentSlot() ) );
