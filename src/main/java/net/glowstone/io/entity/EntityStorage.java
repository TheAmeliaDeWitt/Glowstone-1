...
public final class EntityStorage
{
	...
	static
	{
		...
		bind( new AbstractHorseStore<>( GlowZombieHorse.class, EntityType.ZOMBIE_HORSE, GlowZombieHorse::new ) );
		bind( new AbstractHorseStore<>( GlowSkeletonHorse.class, EntityType.SKELETON_HORSE, GlowSkeletonHorse::new ) );
		...
		bind( new MonsterStore<>( GlowWitherSkeleton.class, EntityType.WITHER_SKELETON, GlowWitherSkeleton::new ) );
