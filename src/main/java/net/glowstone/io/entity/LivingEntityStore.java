...
public abstract class LivingEntityStore<T extends GlowLivingEntity> extends EntityStore<T>
{
	...
	public void save( T entity, CompoundTag tag )
	{
		...
		if ( equip != null )
		{
			...
			tag.putList( "HandDropChances", TagType.FLOAT, Arrays.asList( equip.getItemInMainHandDropChance(), equip.getItemInOffHandDropChance() ) );
			tag.putList( "ArmorDropChances", TagType.FLOAT, Arrays.asList( equip.getBootsDropChance(), equip.getLeggingsDropChance(), equip.getChestplateDropChance(), equip.getHelmetDropChance() ) );
		}
