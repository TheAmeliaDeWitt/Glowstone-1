...
public class RegionFileCache
{
	...
	private LoadingCache<File, RegionFile> regions = CacheBuilder.newBuilder().expireAfterAccess( 5, TimeUnit.MINUTES ).maximumSize( MAX_CACHE_SIZE ).removalListener( removalListener ).build( new CacheLoader<File, RegionFile>()
	{
		@Override
