...
public class ProjectileDispenseBehavior extends DefaultDispenseBehavior
{
	 ...
	 */
	private final BiFunction<? super Location, ? super ItemStack, ? extends Projectile> projectileCreator;
	 ...
	 *                          location
	 */
	public ProjectileDispenseBehavior( Function<? super Location, ? extends Projectile> projectileCreator )
	{
		this( ( location, ignoredItem ) -> projectileCreator.apply( location ) );
	}

	public ProjectileDispenseBehavior( BiFunction<? super Location, ? super ItemStack, ? extends Projectile> projectileCreator )
	{
