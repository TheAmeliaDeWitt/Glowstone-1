...
public class GlowPluginTypeDetector
{
	...
	public void scan()
	{
		...
		GlowServer.logger.info( String.format( "PluginTypeDetector: found %d Bukkit, %d Sponge, %d Forge, %d Canary, " + "%d unknown plugins (total %d)", bukkitPlugins.size(), spongePlugins.size(), forgefPlugins.size() + forgenPlugins.size(), canaryPlugins.size(), unrecognizedPlugins.size(), files.length ) );
