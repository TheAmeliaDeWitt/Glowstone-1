...
public class GlowRepairMatcher extends ItemMatcher
{
	...
	{
		return EnchantmentTarget.ARMOR.includes( item ) || EnchantmentTarget.TOOL.includes( item ) || EnchantmentTarget.WEAPON.includes( item ) || EnchantmentTarget.BOW.includes( item ) || EnchantmentTarget.FISHING_ROD.includes( item );
	}
