...
public class BiomeThinEdgeMapLayer extends MapLayer
{
	...
	static
	{
		...
		EDGES.put( JUNGLE_EDGES, Arrays.asList( GlowBiome.getId( JUNGLE ), GlowBiome.getId( JUNGLE_HILLS ), GlowBiome.getId( MUTATED_JUNGLE ), GlowBiome.getId( MUTATED_JUNGLE_EDGE ), GlowBiome.getId( FOREST ), GlowBiome.getId( TAIGA ) ) );
	}
