...
public class JunglePopulator extends BiomePopulator
{
	...
	private static final TreeDecoration[] TREES = {new TreeDecoration( BigOakTree.class, 10 ), new TreeDecoration( JungleBush.class, 50 ), new TreeDecoration( MegaJungleTree.class, 15 ), new TreeDecoration( CocoaTree.class, 30 )};
