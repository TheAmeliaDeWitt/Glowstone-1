...
public class RoofedForestPopulator extends ForestPopulator
{
	...
	private static final TreeDecoration[] TREES = {new TreeDecoration( GenericTree.class, 20 ), new TreeDecoration( BirchTree.class, 5 ), new TreeDecoration( RedMushroomTree.class, 2 ), new TreeDecoration( BrownMushroomTree.class, 2 ), new TreeDecoration( DarkOakTree.class, 50 )};
