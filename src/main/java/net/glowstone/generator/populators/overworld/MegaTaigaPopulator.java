...
public class MegaTaigaPopulator extends TaigaPopulator
{
	...
	private static final TreeDecoration[] TREES = {new TreeDecoration( RedwoodTree.class, 52 ), new TreeDecoration( TallRedwoodTree.class, 26 ), new TreeDecoration( MegaPineTree.class, 36 ), new TreeDecoration( MegaSpruceTree.class, 3 )};
