...
public class JungleEdgePopulator extends JunglePopulator
{
	...
	private static final TreeDecoration[] TREES = {new TreeDecoration( BigOakTree.class, 10 ), new TreeDecoration( JungleBush.class, 50 ), new TreeDecoration( CocoaTree.class, 45 )};
