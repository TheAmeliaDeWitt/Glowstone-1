...
public class ExtremeHillsPopulator extends BiomePopulator
{
	...
	private static final TreeDecoration[] TREES = {new TreeDecoration( RedwoodTree.class, 20 ), new TreeDecoration( BigOakTree.class, 1 ), new TreeDecoration( GenericTree.class, 9 )};
