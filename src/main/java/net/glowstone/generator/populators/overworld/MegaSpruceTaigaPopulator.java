...
public class MegaSpruceTaigaPopulator extends MegaTaigaPopulator
{
	...
	private static final TreeDecoration[] TREES = {new TreeDecoration( RedwoodTree.class, 44 ), new TreeDecoration( TallRedwoodTree.class, 22 ), new TreeDecoration( MegaSpruceTree.class, 33 )};
