...
public class StructureBoundingBox
{
	...
	{
		return minX <= max.getBlockX() && maxX >= min.getBlockX() && minZ <= max.getBlockZ() && maxZ >= min.getBlockZ();
	}
	...
	{
		return boundingBox.getMin().getBlockX() <= max.getBlockX() && boundingBox.getMax().getBlockX() >= min.getBlockX() && boundingBox.getMin().getBlockY() <= max.getBlockY() && boundingBox.getMax().getBlockY() >= min.getBlockY() && boundingBox.getMin().getBlockZ() <= max.getBlockZ() && boundingBox.getMax().getBlockZ() >= min.getBlockZ();
	}
