...
{
	private static final Material[] SOIL_TYPES = {Material.SAND, Material.DIRT, Material.HARD_CLAY, Material.STAINED_CLAY};
	...
	public void decorate( World world, Random random, Chunk source )
	{
		...
		while ( sourceY > 0 && ( world.getBlockAt( sourceX, sourceY, sourceZ ).isEmpty() || world.getBlockAt( sourceX, sourceY, sourceZ ).getType() == Material.LEAVES ) )
		{
			sourceY--;
		}
