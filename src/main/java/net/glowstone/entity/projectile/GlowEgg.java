...
public class GlowEgg extends GlowProjectile implements Egg
{
	...
	public void collide( Block block )
	{
		...
		getWorld().spawnParticle( Particle.ITEM_CRACK, location, 5, 0, 0, 0, 0.05, new ItemStack( Material.EGG ) );
		remove();
	}
	...
	private void randomSpawnChicken( Location location )
	{
		...
		{
			GlowChicken chicken = ( GlowChicken ) location.getWorld().spawnEntity( location.clone().add( 0, 0.3, 0 ), EntityType.CHICKEN );
			chicken.setBaby();
		}
	}
}
