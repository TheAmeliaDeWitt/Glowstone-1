...
public class GlowArrow extends GlowProjectile implements Arrow
{
	...
	public PickupStatus getPickupStatus()
	{
		...
		return customPickupStatus != null ? customPickupStatus : getShooter() instanceof Monster ? PickupStatus.DISALLOWED : PickupStatus.ALLOWED;
	}
	...
	protected void pulsePhysics()
	{
		...
		if ( !isOnGround() )
		{
			...
			if ( isTouchingMaterial( Material.WATER ) || isTouchingMaterial( Material.STATIONARY_WATER ) )
			{
				setFireTicks( 0 );
			}
			else if ( isTouchingMaterial( Material.LAVA ) || isTouchingMaterial( Material.STATIONARY_LAVA ) )
			{
