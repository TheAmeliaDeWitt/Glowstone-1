...
public class GlowEnderPearl extends GlowProjectile implements EnderPearl
{
	...
	{
		return Arrays.asList( new SpawnObjectMessage( entityId, getUniqueId(), SpawnObjectMessage.THROWN_ENDERPEARL, location ), new EntityMetadataMessage( entityId, metadata.getEntryList() ),
