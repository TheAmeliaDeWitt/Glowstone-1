...
public class GlowWolf extends GlowTameable implements Wolf
{
	...
	{
		return metadata.getBit( MetadataIndex.TAMEABLEAANIMAL_STATUS, MetadataIndex.TameableFlags.WOLF_IS_ANGRY );
	}

	@Override
	public void setAngry( boolean angry )
	{
		metadata.setBit( MetadataIndex.TAMEABLEAANIMAL_STATUS, MetadataIndex.TameableFlags.WOLF_IS_ANGRY, angry );
	}
