...
public class GlowBoss extends GlowMonster
{
	 ...
	 */
	public GlowBoss( Location loc, EntityType type, double maxHealth, String title, BarColor color, BarStyle style, BarFlag... barFlags )
	{
	 ...
	 * @param barFlags  Flags controlling the boss bar.
	 */
	public GlowBoss( Location loc, EntityType type, double maxHealth, BarColor color, BarStyle style, BarFlag... barFlags )
	{
