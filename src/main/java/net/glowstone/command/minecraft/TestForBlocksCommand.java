...
public class TestForBlocksCommand extends VanillaCommand
{
	...
	{
		super( "testforblocks", "Tests whether the blocks in two regions match.", "/testforblock <x1> <y1> <z1> <x2> <y2> <z2> <x> <y> <z> [mode]", Collections.emptyList() );
	...
	public enum MatchMode
	{
		...
		public boolean matches( GlowBlock fromBlock, GlowBlock toBlock )
		{
			...
			return Objects.equals( fromType, toType ) && Objects.equals( fromData, toData ) && Objects.equals( fromEntityTag, toEntityTag );
		}
	}
